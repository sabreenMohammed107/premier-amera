										...
										<div class="header-right-info">
											<ul class="nav navbar-nav mai-top-nav header-right-menu">
												...
												<li>
													...
													<a href="{{ URL::to('changeLang/en') }}" class=" text-white"><span>En</span></a><i class="fa fa-language" style="color:#ffffff"></i>
													@else
													<a href="{{ URL::to('changeLang/ar') }}" class=" text-white"><span>عربي</span><i class="fa fa-language" style="color:#ffffff"></i></a>
												</li>
												@endif
											</ul>
										</div>
										...
										<div class="header-top-menu tabl-d-n">
											<ul class="nav navbar-nav mai-top-nav">
												...
												<li class="nav-item dropdown res-dis-nn">
													<a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><span class="angle-down-topmenu"><i class="fa fa-angle-down"></i></span> {{ __('titles.home') }} </a>
													<div role="menu" class="dropdown-menu animated zoomIn">
														<a href="#" class="dropdown-item">{{ __('titles.home') }}</a>
							...
							<div class="mobile-menu">
								<nav id="dropdown">
									<ul class="mobile-menu-nav">
										...
										<li>
											<a data-toggle="collapse" data-target="#demoevent" href="#">{{ __('titles.home') }} <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
										...
										<li>
											<a data-toggle="collapse" data-target="#demopro" href="#">{{ __('titles.home') }} <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
										...
										<li>
											<a data-toggle="collapse" data-target="#democrou" href="#"> {{ __('titles.home') }} <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
										...
										<li>
											<a data-toggle="collapse" data-target="#demolibra" href="#"> {{ __('titles.home') }} <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
